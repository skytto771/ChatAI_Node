...
// ========== 2. 创建时可选的字段 ==========
export interface MessageCreationAttributes extends Optional<MessageAttributes, 'id' | 'tokensUsed'> {}
...
export class Message extends Model<MessageAttributes, MessageCreationAttributes> implements MessageAttributes {
     ...
     * 构建 AI API 所需的消息格式
     */
    static toOpenAIFormat(messages: Message[]): Array<{ role: string; content: string }> {
    ...
    Message.init(
        ...
        },
        {
            ...
            indexes: [
                ...
                { fields: ['conversation_id', 'created_at'], name: 'idx_conversation_created' },
            ],
        }
    );
